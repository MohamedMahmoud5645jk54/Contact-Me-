...
function sendEmail() {
    ...
    Email.send({
        SecureToken: "47a9639a-6241-4d9e-b133-d8071bf7b832",
        To : 'mhmwdwy34@gmail.com',
        From : "mhmwdwy34@gmail.com",
...
function checkEmail() {
    ...
    const email = document.querySelector("#email"); // Assuming the email input has an id of "email"
